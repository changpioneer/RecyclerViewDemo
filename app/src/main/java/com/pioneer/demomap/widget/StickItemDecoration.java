...
public class StickItemDecoration extends BaseItemDecoration {
    ...
    public StickItemDecoration(GroupListener groupListener) {
    ...
    public static class Builder {
        private StickItemDecoration mDecoration;

        private Builder(GroupListener groupListener) {
            mDecoration = new StickItemDecoration(groupListener);
        }
        ...
        public Builder setGroupTextSize(int textSize) {
            mDecoration.mTextPaint.setTextSize(textSize);
            return this;
        }
