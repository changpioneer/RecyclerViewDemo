...
public class AllRecyclerVeiwActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_recyclerview);
        rv = (RecyclerView) findViewById(R.id.rv_all);
        initData();
    }
    ...
    private void initData() {
        ...
        rvAdapter.setOnItemClickListener(new RvAdapter.OnItemClickListener() {
            ...
            public void onItemClickListener(int position, Integer data) {
                Toast.makeText(AllRecyclerVeiwActivity.this, "点击了" + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.id_action_listview:
                ...
                rv.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
                rvAdapter.setType(RvAdapter.TYPE_VER_LIST);
            ...
            case R.id.id_action_horizontalListView:
                rvAdapter.setType(RvAdapter.TYPE_HOR_LIST);
                rv.removeItemDecoration(itemDecoration);
            ...
            case R.id.id_action_gridview:
                rvAdapter.setType(RvAdapter.TYPE_VER_GRID_LIST);
                rv.setBackgroundColor(Color.TRANSPARENT);
                rv.removeItemDecoration(itemDecoration);
                rv.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
            ...
            case R.id.id_action_staggeredgridview:
                rvAdapter.setType(RvAdapter.TYPE_WATERFALL_LIST);
                rv.setBackgroundColor(Color.TRANSPARENT);
